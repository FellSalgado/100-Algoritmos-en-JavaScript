let algoritmo = "#22 contando ovejas"
...
if (algoritmo == "#11 cambiando dolares") {
}
...
if (algoritmo == "#12 pintado paredes") {
    ...
    alert(`para pintar un pared con un area de ${areaTotal} m², nesecitara ${pintura} litro/s de pintura`);
}
...
if (algoritmo == "#16") {
    ...
    let cigarrosPorDia = parseInt(prompt("escriba cuantos cigarros fuma al dia"))
    let aniosFumando = parseInt(prompt("escriba desde hace cuantos años ya lleva fumando"))
...
if (algoritmo == "#17 exceso de velocidad") {
    ...
    if (velocidad > 80) {
        alert(`Usted fue multado por exceso de velocidad, su multa cuesta $${multa}`)
    } else {
